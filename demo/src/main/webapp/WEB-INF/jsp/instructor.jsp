        ...
        <div class="card flex-grow-1 h-60">
            <div class="question-container d-flex flex-grow-1" >
                ...
                <div class="col-4 p-2 h-100">
                    <div class="question-list-container d-flex flex-column">
                        <div class="card mb-2 flex-grow-1 h-25">
                            <div class="card-body d-flex align-items-center justify-content-between">
                                <input type="text" class="form-control me-2" placeholder="Filter" />
                                <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#questionModal">
                                    ...
                                    <div class="modal-dialog modal-xl">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5 text-center w-100" id="questionModalLabel">Question Select</h1>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <div class="card" id="question-modal-container">
                        ...
                        <div class="card flex-grow-1 overflow-auto h-75 border-0">
                            <ul class="list-group">
                                <c:forEach var="question" items="${questions}">
                                <li class="list-group-item">${question.questionText}</li>
                                </c:forEach>
                            </ul>
                        </div>
                    </div>
